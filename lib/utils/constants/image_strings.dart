...
class XImages {
  ...
  static const String xSplashTopIcon =
      "assets/images/splash_images/splash-top-icon.png";
  static const String xSplashImage =
      "assets/images/splash_images/splash-screen-image.png";

  // -- OnBoarding Screen Images
  static const String xOnBoardingImage1 =
      "assets/images/on_boarding_images/cart.json";
  static const String xOnBoardingImage2 =
      "assets/images/on_boarding_images/delivery.json";
  static const String xOnBoardingImage3 =
      "assets/images/on_boarding_images/welcome.json";
  ...
  // -- SOCIAL Images
  static const String xFacebookLogo = "assets/logo/facebook-logo.png";
  static const String xGoogleIcons = "assets/icons/icons8-google.gif";

  // -- Forget Password Images
  static const String xForgetPasswordImage =
      "assets/images/forget_password/forget-password.png";

  // -- Dashboard Images
  static const String xUserProfileImage =
      "assets/images/dashboard/dash-person.png";
  static const String xBookmarkIcon =
      "assets/images/dashboard/bookmark-icon.png";
  static const String xBannerImage1 = "assets/images/dashboard/dash-01.png";
  static const String xBannerImage2 = "assets/images/dashboard/dash-02.png";
  static const String xTopCourseImage1 = "assets/images/dashboard/dash-03.png";
  static const String xTopCourseImage2 = "assets/images/dashboard/dash-04.png";

  // -- Profile Images
  static const String xProfileImage = "assets/images/profile/profile-pic.png";
  ...
  static String xEmailVerifyAnimation = "assets/images/animations/Book.json";
